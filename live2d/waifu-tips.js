...
live2d_settings['l2dVerDate']           = '2020.05.27'; // 版本更新日期
live2d_settings['homePageUrl']          = 'https://beyondhxl.com/';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://beyondhxl.com/about/';   // 关于页地址, '{URL 网址}'
